...
config['func']=None
with open(f'results/config_{run_name}.json','w') as f:
    json.dump(config,f)
...
with open(f'results/stats_{run_name}.json', 'w') as f:
    json.dump(data_to_save, f, indent=2)

'''
clip_to = 1000
fig_losses = go.Figure()
fig_losses.add_trace(go.Scatter(y=result_modadd['losses'][:clip_to], mode='lines', name='Training Loss'))
fig_losses.add_trace(go.Scatter(y=result_modadd['losses_val'][:clip_to], mode='lines', name='Validation Loss'))
fig_losses.update_layout(title=f'Training and Validation Loss Over Time (First {clip_to} Epochs)', xaxis_title='Epoch', yaxis_title='Loss')
fig_losses.show()

fig_accs = go.Figure()
fig_accs.add_trace(go.Scatter(y=result_modadd['accs'][:clip_to], mode='lines', name='Training Accuracy'))
fig_accs.add_trace(go.Scatter(y=result_modadd['accs_val'][:clip_to], mode='lines', name='Validation Accuracy'))
fig_accs.update_layout(title=f'Training and Validation Accuracy Over Time (First {clip_to} Epochs)', xaxis_title='Epoch', yaxis_title='Accuracy')
fig_accs.show()